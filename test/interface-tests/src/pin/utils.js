...
export const fixtures = Object.freeze({
  ...
  directory: Object.freeze({
    ...
    files: Object.freeze([Object.freeze({
      ...
      data: loadFixture('test/interface-tests/fixtures/test-folder/ipfs-add.js', 'interface-ipfs-core'),
      cid: CID.parse('QmbKtKBrmeRHjNCwR4zAfCJdMVu6dgmwk9M9AE9pUM9RgG')
    }), Object.freeze({
      path: 'test-folder/files/ipfs.txt',
      data: loadFixture('test/interface-tests/fixtures/test-folder/files/ipfs.txt', 'interface-ipfs-core'),
  ...
  files: Object.freeze([Object.freeze({
    ...
    data: loadFixture('test/interface-tests/fixtures/test-folder/files/hello.txt', 'interface-ipfs-core'),
